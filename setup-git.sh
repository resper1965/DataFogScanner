...
echo "2. Adicione o remote: git remote add origin <URL-DO-SEU-REPOSITORIO>"
echo "3. Envie o código: git push -u origin main"
echo ""
print_warning "Exemplo de comandos:"
echo "git remote add origin https://github.com/seu-usuario/datafog-pii-detector.git"
