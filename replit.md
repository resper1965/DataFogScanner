...
- June 14, 2025. Created final production installer (install-production.sh) for fluent GitHub-based deployment. Replaced PM2 with systemd for enterprise reliability, implemented comprehensive security hardening, updated documentation with single-command installation process. VPS deployment now available via: curl -fsSL https://raw.githubusercontent.com/resper1965/DataFogScanner/main/install-production.sh | bash
